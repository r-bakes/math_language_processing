...
parser.add_argument("--n", default=500, type=int, help="Number of questions to train and test with")
parser.add_argument("--e", default=1, type=int, help="Number of epochs (only applicable to neural nets)")
parser.add_argument("--m", default='rnd_fst', choices=['test','lstm', 'rnd_fst'], type=str, help="model to train")
